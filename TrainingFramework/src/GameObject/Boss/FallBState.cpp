#include "FallBState.h"


FallBState::FallBState(IBoss* boss)
{
	m_Boss = boss;
	m_currentTime = 0.0f;
}

void FallBState::Init(std::string nameFile, int numFrames, float frameTime, int width, int height, Vector2 pos)
{
...
void FallBState::Draw()
{
	m_Image->Draw();
}

void FallBState::Update(float deltaTime)
{
...
void FallBState::ResetAnimation()
{
